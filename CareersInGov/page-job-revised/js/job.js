$(document).ready(function () {
  ...
  // ABOUT THE COMPANY Section links
  $('.cig-company-info-secondary-wrapper li a').each(function (index) {
    var textContent = $(this).text();

    if (index === 0) {
      $(this).attr('href', 'tel:' + textContent.replace(/-/g, ''));
    } else {
      $(this).attr('href', textContent);
    }
  });
});